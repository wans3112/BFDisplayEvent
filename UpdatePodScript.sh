...
pod lib lint --sources=$privateSpecs --verbose --use-libraries --allow-warnings

pod repo push WBSpecs $podspecName.podspec --sources=$privateSpecs --use-libraries --allow-warnings
